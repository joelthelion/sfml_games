...
int main() {
  ...
  // sf::RenderWindow window(sf::VideoMode(gameWidth, gameHeight, 32), "SFML
  // Pong");
  // sf::RenderWindow window(sf::VideoMode::getFullscreenModes()[0], "SFML
  // Pong");
  sf::RenderWindow window(sf::VideoMode::getDesktopMode(), "SFML Pong",
                          sf::Style::Fullscreen);
  window.setVerticalSyncEnabled(true);
  const int gameWidth = window.getSize().x;
  const int gameHeight = window.getSize().y;
